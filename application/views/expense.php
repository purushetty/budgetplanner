...
<body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="container">
      	<div class="row">
        	<div class="col-md-2 admin-sess">
            <a href="<?php echo base_url() ?>login/dashboard" id="dboard"><button class="btn btn-med btn-default" id="dboard-btn">Admin Dashboard</button></a>
            </form>
            </div>
			<div class="col-md-3 col-md-offset-7 user-sess">
            	Welcome <?=$this->session->userdata('first_name')?>&nbsp;&nbsp;<a href="<?php echo base_url()?>login/logout" id="lout"><button class="btn btn-med btn-default" type="button" id="logoutb">Logout</button></a>
            </div>
        </div>
        </div>
        <!-- /.container -->
...
<script src="<?php echo base_url();?>assets/js/bootstrap-3.3.4.js" type="text/javascript"></script>
